# Full-stack portfolio upgrade

- [x] Upgrade the project with authenticated backend, database, and file storage.
- [x] Add owner-only admin access for Khairy and keep admin routes hidden from public visitors.
