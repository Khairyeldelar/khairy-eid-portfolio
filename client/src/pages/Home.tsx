...
const projects = [
  { title: "AI, in plain language", category: "ai", ar: "الذكاء الاصطناعي", en: "AI", descAr: "نظام محتوى يشرح أدوات الذكاء الاصطناعي بلغة عملية.", descEn: "A content system that explains AI tools in practical language.", image: assets.ai, year: "2024" },
  { title: "A softer brand system", category: "design", ar: "تصميم", en: "Design", descAr: "هوية بصرية لمشروع رقمي يريد أن يبدو إنسانيًا وواضحًا.", descEn: "A visual identity for a digital project that wanted to feel human and clear.", image: assets.brand, year: "2024" },
  { title: "The content studio", category: "content", ar: "محتوى", en: "Content", descAr: "منهج عمل لتخطيط المحتوى وإنتاجه ونشره باستمرار.", descEn: "A working method for planning, producing, and publishing consistently.", image: assets.content, year: "2023" },
];
const tutorials = [
